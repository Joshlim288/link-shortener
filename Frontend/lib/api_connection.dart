...
class ApiConnection {
  ...
  static Future<void> shortenUrl(String url, Function(String) callback) async {
    var request = http.Request('GET', Uri.parse('$baseUrl/shorten?url=$url'));
    sendRequest(request, callback);
  }

  /// enter match results into the system
  static Future<void> retrieveUrl(String base62code, Function(String) callback) async {
